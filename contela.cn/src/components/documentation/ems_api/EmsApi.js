        ...
        <div class="card md-4 EmsApi">
            ...
            <div class="card-body">
                <li>
                    ...
                    <ul>
                        POST 요청마다, 새로운 Resource가 생성됨
                    </ul>
                </li>
                <li>
                    PUT
                    <ul>
                        새로운 Resource의 생성과 수정을 담당
                    </ul>
                    <ul>
                        PUT 요청마다, 같은 Resource가 반환됨, 속성은 변경 가능
                    </ul>
                </li>
                <li>
                    [value]
                ...
                <table class="datatable-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td>PCF에 [value]에 해당하는 PLMN의 등록 여부 확인</td>
                        </tr>
                        <tr>
                            <td>PUT</td>
                            <td>PLMN</td>
                            <td></td>
                            <td>PCF에 PLMN을 [value]에서 PLMN로 Change</td>
                        </tr>
                        <tr>
                            <td>DELETE</td>
                            <td></td>
                            <td></td>
                            <td>PCF에 [value]에 해당하는 PLMN을 Delete</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td>PCF에 [value]에 해당하는 TAC 등록 여부 확인</td>
                        </tr>
                        <tr>
                            <td>PUT</td>
                            <td></td>
                            <td>TAC</td>
                            <td>PCF에 TAC를 [value]에서 TAC로 Change</td>
                        </tr>
                        <tr>
                            <td>DELETE</td>
                            <td></td>
                            <td></td>
                            <td>PCF에 [value]에 해당하는 TAC Delete</td>
                        </tr>
                ...
                <table class="datatable-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info를 Display</td>
                        </tr>
                        <tr>
                            ...
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info를 AM Policy Info로 Change</td>
                        </tr>
                        <tr>
                            <td>DELETE <BsCheckSquare /></td>
                            <td></td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info를 Delete</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 RFSP Index 값을 Display</td>
                        </tr>
                        <tr>
                            <td>POST</td>
                            <td>RFSP Index value</td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 RFSP Index 값을 Create</td>
                        </tr>
                        <tr>
                            <td>PUT</td>
                            <td>RFSP Index value</td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 RFSP Index 값을 Change</td>
                        </tr>
                        <tr>
                            <td>DELETE</td>
                            <td>RFSP Index value</td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 RFSP Index 값을 Delete</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>Type, TAC List</td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 Service Area Restriction 정보를 Display</td>
                        </tr>
                        <tr>
                            <td>POST</td>
                            <td>Type, TAC List</td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 Service Area Restriction 정보를 Create</td>
                        </tr>
                        <tr>
                            <td>DELETE</td>
                            <td>[Type], [TAC List]</td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 Service Area Restriction 정보를 Delete</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>Type value</td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 Service Area Restriction 정보에서 Type을 Display</td>
                        </tr>
                        <tr>
                            <td>PUT</td>
                            <td>Type value</td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 Service Area Restriction 정보에서 Type을 &#123;value&#125;로 Change</td>
                        </tr>
                        <tr>
                            <td>DELETE</td>
                            <td>Type value</td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 Service Area Restriction 정보에서 Type을 Delete</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>*TAC</td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 Service Area Restriction 정보에서 TAC List을 Display</td>
                        </tr>
                        <tr>
                            <td>PUT</td>
                            <td>*TAC</td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 Service Area Restriction 정보에서 TAC List을 Change</td>
                        </tr>
                        <tr>
                            <td>DELETE</td>
                            <td>*TAC</td>
                            <td></td>
                            <td>PCF에서 AM Policy Name이 [value]인 AM Policy Info의 Service Area Restriction 정보에서 TAC List을 Delete</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="datatable-table">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                Policy Assoc Info에서 IMSI에 적용된 AM Policy Name을 Delete<br/>
                                Request에 IMSI가 없는 경우, 모든 Policy Assoc Info 정보 삭제
                            </td>
                        </tr>
                    </tbody>
                </table>
